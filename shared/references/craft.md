...
Measured 2026-08-06: `novoads-claymation-storyboard-ad` was found carrying the
...
**Canonical home:** `skills/novoads-pixar-storyboard-ad/SKILL.md`, Gate 7 — the
...
**Canonical home:** `skills/novoads-pixar-storyboard-ad/SKILL.md`, § Trim to the
...
Rules 2 and 3 are stated in full inside `novoads-pixar-storyboard-ad` rather than
...
| `skills/novoads-pixar-storyboard-ad` | 2, 3 — canonical home for both |
| `skills/novoads-claymation-storyboard-ad` | 2, 3 — points at its Pixar sibling |
