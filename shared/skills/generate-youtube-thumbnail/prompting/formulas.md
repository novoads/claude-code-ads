...
Each formula is a layout pattern that has been tested and validated. Pick based on the user's intent (see the decision matrix in the `generate-youtube-thumbnail` skill's `SKILL.md`).
