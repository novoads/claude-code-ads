...
# Prefer whatever is on PATH — the skills tell the user to check with `which ffmpeg`,
# and an Intel Mac (/usr/local/bin) or Linux would otherwise pass that check and still
# fail here. Override either with FFMPEG= / FFPROBE=.
