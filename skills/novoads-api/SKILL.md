...
| B-roll cutaways, background music, or variations of a finished ad | Not part of making the ad. Deliver the base video first, then **offer** these as a separate pass — b-roll **overlays** the base (its audio keeps running, the final duration is unchanged), it does not extend it |
